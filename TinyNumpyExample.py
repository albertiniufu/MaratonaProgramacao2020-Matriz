...
def mainCode():
    ...
    L1=array(L1) # converte a lista para usar o numpy
    print(type(L1))  # verifica o tipo de dados da variável L1 <class '__main__.ndarray'>
    print(L1) # Imprime os elementos da lista
    ...
    L1=ones((5,5)) #Cria um vetor de uns (5 x 5)
    print(L1) # Imprime os elementos
    L1=zeros((5,5)) #Cria um vetor de zeros (5 x 5)
    print(L1) # Imprime os elementos

    Mat1=array([ [1,2,3], [4,5,6] ])
    Mat2=array([ [9,8,7], [6,5,5] ])
    print(Mat1)
    print(Mat2)
    ...
    print(Mat1)
    print(Mat2)
    print(dot(Mat2,Mat1)) # realiza a multiplicação das matrizes
